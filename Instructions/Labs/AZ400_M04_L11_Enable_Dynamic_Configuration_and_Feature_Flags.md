...
1. Klicken Sie auf **Speichern und Ausführen**, und warten Sie, bis die Pipeline erfolgreich ausgeführt wird.
    ...
    > **Hinweis:** Sie müssen zweimal auf **Speichern und ausführen** klicken. Wenn im Fenster „Aufträge“ eine Meldung angezeigt wird, dass Berechtigungen erforderlich sind, wählen Sie im Fenster „Aufträge“ die Option **Bereitstellen**, anschließend **Anzeigen** und dann zweimal **Zulassen** aus, um die Pipelineausführung abzuschließen.
...
1. Aktivieren Sie im Abschnitt **Mitglieder** die Option **Identität verwalten**, und klicken Sie dann auf **+ Mitglieder auswählen**. Wählen Sie im Feld **Verwaltete Identität** die Option **App Service (1)** und dann Ihre App Service-Instanz aus, und klicken Sie auf **Auswählen**.
1. Klicken Sie zweimal auf **Überprüfen und zuweisen**, um die Rollenzuweisung abzuschließen.
