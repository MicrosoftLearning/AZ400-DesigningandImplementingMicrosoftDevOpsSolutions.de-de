...
- Als Teil des Validierungsprozesses für Pull Requests
- Als Teil der Implementierung der kontinuierlichen Integration
...
1.  Das Repository ist wie folgt organisiert:
    ...
    - Der Ordner **src** enthält die .NET 6 Website, die in den Laborszenarien verwendet wird.
...
1. Gehen Sie zum Abschnitt **Repo > Verzweigungen**.
...
1. Klicken Sie auf der Registerkarte **main** der Repository-Einstellungen auf **Buildüberprüfung hinzufügen** und wählen Sie in der Build-Pipeline-Liste **eshoponweb-ci-pr** und klicken Sie dann auf **Speichern**.
...
1. Erstellen einer neuen Verzweigung mit dem Namen **Feature01** basierend auf der Verzweigung **Standard**
1. Navigieren Sie zur Datei **/eShopOnWeb/src/Web/Program.cs** als Teil der Verzweigung **Feature01** und nehmen Sie die folgende Änderung in der ersten Zeile vor:
...
1. Klicken Sie auf die Schaltfläche **Pipeline erstellen**.
...
1. Wählen Sie die Datei **/.ado/eshoponweb-ci.yml** und klicken Sie dann auf **Fortfahren**
...
1. Nun müssen Sie die Abschnitte **Trigger** und **Resources** durch den folgenden Code ersetzen:
...
1. Klicken Sie auf die Schaltfläche **Speichern**, um die Pipeline-Definition zu speichern.
1. Wählen Sie **Eine neue Verzweigung für diesen Commit erstellen** aus.
...
1. Wechseln Sie zu **Repos > Pullrequests**
1. Klicken Sie auf die vorhandene Pullanforderung
1. Nachdem alle Überprüfungen erfolgreich waren, klicken Sie oben mit der rechten Maustaste auf **Genehmigen**. Jetzt können Sie auf **Abschließen** klicken.
1. Klicken Sie auf der Registerkarte **Pull Request abschließen** auf **Zusammenführen abschließen**.
...
1. Navigieren Sie zum Abschnitt **Repos**.
1. Erstellen Sie einen neuen Branch mit dem Namen **Feature02** basierend auf dem **Mainbranch**.
1. Navigieren Sie zur Datei **/eShopOnWeb/src/Web/Program.cs** als Teil der Verzweigung **Feature02** und entfernen Sie die erste Zeile:
...
1. Klicken Sie auf **Commit > Commit** (Standard-Commit-Nachricht belassen).
1. Eine Nachricht wird angezeigt und schlägt vor, einen Pull Request zu erstellen (da Ihre Verzweigung **Feature02** im Vergleich zur **auptverzweigung** jetzt akuellere Änderungen enthält). Klicken Sie auf **Pull Request erstellen**.
1. Belassen Sie die Standardeinstellungen auf der Registerkarte **Neuer Pull Request** und klicken Sie auf **Erstellen**.
1. Der Pull Request zeigt einige ausstehende Anforderungen basierend auf den Richtlinien an, die für die Ziel-**Hauptverzweigung** gelten.
1. Nachdem alle Überprüfungen erfolgreich waren, klicken Sie oben mit der rechten Maustaste auf **Genehmigen**. Jetzt können Sie auf **Abschließen** klicken.
1. Klicken Sie auf der Registerkarte **Pull Request abschließen** auf **Zusammenführen abschließen**.
...
1. Klicken Sie nach erfolgreicher Ausführung auf **Zugehörige > Veröffentlicht**, um die veröffentlichten Artefakte zu überprüfen:
    - Bicep: das Infrastruktur-Artefakt
